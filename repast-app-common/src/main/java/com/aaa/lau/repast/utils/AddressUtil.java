package com.aaa.lau.repast.utils;
 ...
 * @Description:
 *      http://api.map.baidu.com/location/ip?ak=WdktKYisEB6qfQVXzX9h7rVzTPWRajKi&ip=222.137.210.39&coor=bd09ll //HTTP协议
 * @Author: Thor Lau
 * @Create: 2020-03-12 10:19
 **/
public class AddressUtil {
    public static Map<String, Object> getAddresses(String content, String encodingString)
            throws UnsupportedEncodingException {
        // 这里调用淘宝API
        String urlStr = "http://api.map.baidu.com/location/ip?ak=WdktKYisEB6qfQVXzX9h7rVzTPWRajKi&ip="+content+"&coor=bd09ll";
...
//            }
            ...
            resultMap.put("province",addressArray[0]);
            resultMap.put("city",addressArray[1]);
            resultMap.put("country",addressArray[2]);
            return resultMap;
        }
        return null;
    }
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        Map<String, Object> address = AddressUtil.getAddresses("222.137.210.39", "UTF-8");
